...
```sh
sh src/cobs/tests/bench/run.sh
```
...
```sh
COBS_BENCH_MIB=64 sh src/cobs/tests/bench/run.sh
```
...
Correctness belongs to `src/cobs/tests/run.sh`, sanitizers and the exhaustive
