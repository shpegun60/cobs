...
def verify():
    cobs_dir = SRC / "cobs/tests/hardware/h7s"
    ...
    rtu_dir = SRC / "modbus/rtu/tests/hardware/h7s"
    ...
    arm = json.loads((SRC / "crc/tests/results_shared_policies_arm_2026-09-05.json").read_text())
