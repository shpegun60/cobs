...
private:
	...
	virtual void onRxCplt(const u16 newPos) noexcept = 0;
	virtual inline void onTxCplt() noexcept = 0;
	virtual void onErrorEvent() noexcept  = 0;
...
public:
	...
	static void reserve(const u8 n);
